...
<head>
    ...
    <link rel="stylesheet" href="//cdn.datatables.net/v/bs4/dt-1.10.20/b-1.6.5/r-2.2.6/sl-1.3.1/datatables.min.css"/>
...
<script>
    ...
    //process form validation laravel errors
    const processErrors = function (data) {
        let result = "";
        ...
        $.ajaxSetup({
            ...
            error: function (x, status, error) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    html: x.status === 422 ? processErrors(x.responseJSON.errors) : (x.responseJSON?.error || 'Something Went Wrong'),
                });
            }
        });
    }())
